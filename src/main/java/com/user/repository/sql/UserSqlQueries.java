...
public class UserSqlQueries {
    ...
    public static final String SELECT_QUERY_FOR_EMAIL = "SELECT * FROM util_sch.USERS WHERE email = ?";
    public static final String UPDATE_QUERY = "UPDATE util_sch.USERS SET first_name=?, last_name=?, email=?, password=? " +
            "WHERE id = ?";
    public static final String DELETE_QUERY = "DELETE FROM util_sch.USERS WHERE id = ?";
